...
public class Activity_Arcade_Game extends AppCompatActivity implements Interface_Arcade_Game, Interface_General_Game_Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonQuestion = findViewById(R.id.button_arcade_game_question);
    ...
    protected void onResume() {
        ...
        if(interstitialAd == null) {
            ...
            interstitialAd.load(this, "ca-app-pub-6308768432168130/2816335373", adRequestInterstitial, new InterstitialAdLoadCallback() {
                @Override
    ...
    public void setFragment(int fragmentType) {
        if (fragmentType == 0) {
            ...
            getSupportFragmentManager().beginTransaction()
                    ...
                    .add(R.id.fragment_container_arcade_game, (Fragment) fragment, null)
                    .commit();
        }
    ...
    public void openHowToPlay() {
        Button buttonOk = viewHowToPlayDialog.findViewById(R.id.button_how_to_play_arcade_ok);

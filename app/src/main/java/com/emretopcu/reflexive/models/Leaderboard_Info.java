...
public class Leaderboard_Info {
    ...
    private Leaderboard_Info(){
        classicLeaderboard = new Leaderboard_Info_Object_Type[Common_Parameters_Variables.NUMBER_OF_LEADERBOARD_USERS];
        arcadeLeaderboard = new Leaderboard_Info_Object_Type[Common_Parameters_Variables.NUMBER_OF_LEADERBOARD_USERS];
        survivalLeaderboard = new Leaderboard_Info_Object_Type[Common_Parameters_Variables.NUMBER_OF_LEADERBOARD_USERS];
